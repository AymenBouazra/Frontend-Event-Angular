...
export class TagsComponent implements OnInit {
  ...
  constructor(private tag: TagService, private router: Router, private route: ActivatedRoute, private toastr: ToastrService, private sweetAlert: SweetAlertService) { }
  ...
  delete(id: number) {
    this.sweetAlert.deleteConfirmation('tag').then((result) => {
      if (result.value) {
